      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        {error && (
          <div className="bg-red-500/10 border border-red-500/30 text-red-400 text-sm rounded-xl px-4 py-3 text-center">
            {error === 'AccessDenied'
              ? 'Your account is not authorised. Contact an admin to be added.'
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-zinc-100 text-zinc-900 font-semibold py-3 px-6 rounded-xl transition-colors"
        >
